...
**Known doc/code divergences**: three documented in [CODEBASE_NOTES.md](CODEBASE_NOTES.md) #25 — one stale line in the AI collaboration guide's divergence table, and two ADRs (005, 007) that describe an implementation that was never fully built. Fix the first; supersede the ADRs.
