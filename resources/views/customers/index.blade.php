...
<x-card :padding="false">
    <x-data-table :headers="['Customer', 'Email', 'Phone', 'Total Orders', 'Balance', 'Total Spent', 'Actions']">
        ...
        <tr>
            ...
            <td>
                <div style="display: flex; gap: 8px;">
                    ...
                    <a href="{{ route('customers.edit', $customer->id) }}" class="btn btn-icon btn-secondary btn-sm" title="Edit">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
